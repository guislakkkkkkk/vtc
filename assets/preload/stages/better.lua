function onCreate()
    ...
    --preloading the old stage
   	makeAnimatedLuaSprite('stageback1','julian/tha_swag_wal', -870, -360)
	...
	setLuaSpriteScrollFactor('stageback1', 0.9, 0.9);
   	...
   	makeAnimatedLuaSprite('stagefront1','julian/tha_cool_groun', -600, -350)
	...
	makeLuaSprite('stageback', 'julian/thawal', -870, -360);
	setLuaSpriteScrollFactor('stageback', 0.9, 0.9);

	makeLuaSprite('stagefront', 'julian/thagroun', -600, -350);
	...
	makeLuaSprite('jackettt', 'julian/number12COCK', 450, 400);
