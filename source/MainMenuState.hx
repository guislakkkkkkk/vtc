...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		switch (FlxG.random.int(1, 6))
            {
            case 1:
			char = new FlxSprite(790, 20).loadGraphic(Paths.image('mainmenu/brnito'));
            ...
            case 2:
			char = new FlxSprite(790, 20).loadGraphic(Paths.image('mainmenu/GF_ass_sets_3'));
			...
			case 3:
			char = new FlxSprite(790, 20).loadGraphic(Paths.image('mainmenu/minus_rayna'));
			...
			case 4:
			char = new FlxSprite(795, 10).loadGraphic(Paths.image('mainmenu/rayna'));
			...
			case 5:
			char = new FlxSprite(790, 10).loadGraphic(Paths.image('mainmenu/rayna_assets'));
			...
			case 6:
			char = new FlxSprite(790,95).loadGraphic(Paths.image('mainmenu/RAYNABF'));
			...
			case 7:
			char = new FlxSprite(790, 50).loadGraphic(Paths.image('mainmenu/valen'));
