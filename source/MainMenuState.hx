...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		switch (FlxG.random.int(1, 6))
            {
            case 1:
			char = new FlxSprite(790, 50).loadGraphic(Paths.image('mainmenu/brnito'));
			...
			case 4:
			char = new FlxSprite(790, 50).loadGraphic(Paths.image('mainmenu/rayna'));
			...
			case 5:
			char = new FlxSprite(790, 50).loadGraphic(Paths.image('mainmenu/rayna_assets'));
			...
			case 6:
			char = new FlxSprite(790, 50).loadGraphic(Paths.image('mainmenu/RAYNABF'));
